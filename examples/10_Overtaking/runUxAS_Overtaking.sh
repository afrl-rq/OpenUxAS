...
cd $BIN2
/usr/bin/gnome-terminal -x java -Xmx2048m -splash:./data/amase_splash.png -classpath ./dist/*:./lib/*  avtas.app.Application --config config/daidalus --scenario "../../../../../../examples/10_Overtaking/MessagesToSend/overtaking.xml"; 
sleep 5s
