...
cd $BIN2
/usr/bin/gnome-terminal -x java -Xmx2048m -splash:./data/amase_splash.png -classpath ./dist/*:./lib/*  avtas.app.Application --config config/daidalus --scenario "../../OpenUxAS/examples/12_Patrol/MessagesToSend/Patrol.xml"; 
...
/usr/bin/gnome-terminal -e $BIN" -cfgPath ../cfgPatrol_$UAV.xml"
