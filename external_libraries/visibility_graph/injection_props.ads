...
package injection_props with SPARK_Mode is
  ...
  --TODO: Add precondition
   ...
   -- As the above cannot be directly implemented, instead we do the following:
   -- Returns true if and only if:
   -- 1. Any vertex of polygon A is inside polygon B, OR
   -- 2. Any vertex of polygon B is inside polygon A, OR
   -- 3. Any edge of polygon A intersects any edge of polygon B.
   function merge_pre_condition(A, B : simple_polygon_2d) return Boolean;
